...
import k8s.spring.demo.IntegrationTest;
import k8s.spring.demo.config.Constants;
import k8s.spring.demo.domain.User;
import k8s.spring.demo.repository.AuthorityRepository;
...
import k8s.spring.demo.service.dto.PasswordChangeDTO;
import k8s.spring.demo.web.rest.vm.KeyAndPasswordVM;
import k8s.spring.demo.web.rest.vm.ManagedUserVM;
